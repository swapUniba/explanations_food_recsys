...
ini_set('session.save_path', '/var/lib/php5/session');
@session_start();
                                ...
                                <div class="blog-text">
                                    <div id="expB" class="blog-desc">
                                        <p><font color="black">"popularity_two":<?= $explanations[$dish]["popularity_two"] ?>
                                                ...
                                                <br> "foodFeatures_two":<?= $explanations[$dish]["foodFeatures_two"] ?>
                                                <br> "foodFeatureHealthRisk_two":<?= $explanations[$dish]["foodFeatureHealthRisk_two"] ?>
                                                <br> "foodFeatureHealthBenefits_two":<?= $explanations[$dish]["foodFeatureHealthBenefits_two"] ?></font></p>
                                    </div>
                                </div>
                            </div>
                        </div>
